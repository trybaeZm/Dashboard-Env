...
const menuGroups = [
  {
    ...
    menuItems: [
      ...
      {
        icon: <EyeDropperIcon className="size-7" />,
        label: "Forms",
        route: "#",
        children: [
...
const Sidebar = ({ sidebarOpen, setSidebarOpen }: SidebarProps) => {
  ...
  return (
    <ClickOutside onClick={() => setSidebarOpen(false)}>
      <aside
        className={`w-60.5 fixed left-0 top-0 z-9999 flex h-screen flex-col overflow-y-hidden border-r-2 border-gray-100 bg-[#ffff] duration-300 ease-linear dark:border-strokedark dark:bg-boxdark lg:translate-x-0 ${
        ...
        <div className="no-scrollbar flex flex-col overflow-y-auto duration-300 ease-linear">
          ...
          <nav className="mt-5 px-2 py-4 lg:mt-9 lg:px-2">
            {menuGroups.map((group, groupIndex) => (
              <div key={groupIndex}>
                <h3 className="mb-4 ml-4 text-sm font-semibold text-[#616262]">
                  {group.name}
                </h3>
