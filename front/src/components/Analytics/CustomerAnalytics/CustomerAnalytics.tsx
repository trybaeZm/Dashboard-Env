...
export const CustomerAnalytics = () => {
  ...
  return (
    <div className="flex flex-col dark:text-white dark:bg-black gap-5 pt-20 justify-center   ">
      <div className="border flex flex-col gap-3 grow p-4 items-center rounded-md">
        <div className="w-full font-bold">
        Revenue & Spending
        </div>
        <div className="flex gap-4 flex-wrap">
          <div className="border max-w-[300px] grow border-[#C9C9C9] p-3 rounded-md">
            <div className="">
            ...
            <div>
              <div className="text-[#1A0670] ">Top Customers</div>
              <div className="flex text-[#1A0670] justify-between items-end">
                ...
                <button onClick={() => navigation.push('customer-analytics/customer_gender_ratio')} className="py-1 px-2 rounded-[100px] bg-[#1A0670] text-white">view data</button>
              </div>
            </div>
          </div>
          {/* chart */}
          <div className="border grow border-[#C9C9C9] p-4 rounded-md">
            ...
            <div>
              <div className="text-[#1A0670] ">High-Value vs. Low-Value Customers</div>
              <div className="flex text-[#1A0670] justify-between items-end">
                <div className="flex items-end gap-2">
                  <div className="font-bold text-2xl">25.7K</div>
                  <div className="text-sm font-light">last 7 days</div>
      ...
      <div className="border flex flex-col gap-3 grow p-5 items-center   rounded-md">
        ...
        <div className="flex gap-4 flex-wrap">
          <div className="border grow-0 border-[#C9C9C9] p-3 rounded-md">
            <div className="grow">
            ...
            <div>
              <div className="text-[#1A0670] ">Customer Gender Ratio</div>
          ...
          <div className="border grow border-[#C9C9C9] p-3 rounded-md">
            ...
            <div>
              <div className="text-[#1A0670] ">Geographical Location of Customers</div>
              <div className="flex text-[#1A0670] justify-between items-end gap-2">
                <div className="flex items-end gap-2">
      ...
      <div className="border flex flex-col gap-3 grow p-5 items-center   rounded-md">
        ...
        <div className="flex gap-4 flex-wrap">
          <div className="border grow-0 border-[#C9C9C9] p-3 rounded-md">
            ...
            <div>
              <div className="text-[#1A0670] ">Customer Retention Rates</div>
              <div className="flex text-[#1A0670] justify-between items-end gap-2">
                <div className="flex items-end gap-2">
          ...
          <div className="border grow border-[#C9C9C9] p-3 rounded-md">
            ...
            <div>
              <div className="text-[#1A0670] ">New vs. Repeat Customers</div>
              <div className="flex text-[#1A0670] justify-between items-end gap-2">
                <div className="flex items-end gap-2">
