        ...
        <div className='pt-20 flex flex-col gap-10 items-center p-3'>
            <div className='w-full'>
                <div className='flex gap-4 items-center'>
                    ...
                    <div className='text-[#8B909AA8] text-xl flex gap-5 items-center font-bold'>
                        Total Sales Over Time  <span className='text-[#1A0670] text-2xl'> ZMW 27,500 </span>
                    </div>
                </div>
                <div>
                </div>
            ...
            <div className='w-full'>
                <div className='flex overflowY-auto gap-6 text-xl'>
                    <button>January  <div className='h-[5px] bg-black'></div></button>
                ...
                <div className='w-full flex items-center pe-5 justify-end'>
                    <DropdownMenu>
                        ...
                        <DropdownMenuContent>
                            <DropdownMenuSeparator />
                            <DropdownMenuItem>By: Sales Value</DropdownMenuItem>
                ...
                <div className='grow'>
                    <div className='flex justify-between '>
                        <div className='text-center'>
                            ...
                            <div className='font-light'>Current Month Revenue</div>
                        </div>
                        <div className='text-center'>
                        ...
                        <div className='text-center'>
                            ...
                            <div className='font-light'>Growth from Previous Month</div>
                        </div>
                    </div>
                    <div>
                        <Table open={setOpen} />
