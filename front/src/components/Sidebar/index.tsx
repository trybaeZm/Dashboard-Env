...
const Sidebar = ({ sidebarOpen, setSidebarOpen }: SidebarProps) => {
  ...
  return (
    <ClickOutside onClick={() => setSidebarOpen(false)}>
      <aside
        className={`w-60.5 fixed left-0 top-0 z-9999 flex h-screen flex-col overflow-y-hidden border-r-2 border-gray-100  bg-[#ffff] duration-300 ease-linear dark:border-strokedark dark:bg-gray-500 ${
