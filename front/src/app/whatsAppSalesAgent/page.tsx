                ...
                <div className='flex gap-10 flex-col'>
                    ...
                    <div className='flex gap-5 grow'>
                        <div className='grow w-full'>
                            <div className='border rounded-md border-black h-full'>
                ...
                <div className='w-[80%] bg-white rounded-lg overflow-hidden overflow-hidden shadow relative'>
                    ...
                    <div className='p-10'>
                        ...
                        <div className='absolute bottom-10 right-10 flex gap-3 '>
                            <button onClick={() => setPage(page - 1)} className={`border  border-black text-white font-bold p-3 rounded-[50%] $${(page > 1) ? " " : " hidden "}`}>
                                <ArrowLeftIcon className="size-6 text-black" />
                            </button>
                            <button onClick={() => setPage(page + 1)} className={`bg-black text-white font-bold p-3 rounded-[50%] ${(page == 5 ) ? " hidden " : "  "} `}>
