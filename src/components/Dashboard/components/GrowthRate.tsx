...
export const GrowthRate = ({ data }: { data: any }) => {
    ...
    return (
        <div className="relative h-full rounded-xl dark:bg-gray-800 bg-gradient-to-br from-white to-gray-100 dark:from-gray-700 dark:to-gray-900 shadow-xl flex flex-col gap-1 text-center justify-center border dark:border-gray-600 border-gray-200">
            {/* Decorative Top Icon */}
